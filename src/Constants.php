...
class Constants
{
	...
	public const moneyTypes2 = [
		1 => "TL",
		2 => "USD",
		3 => "Euro",
	];
	public const contactOptions = [
		1 => [
			"text" => "WhatsApp",
		],
		2 => [
	...
	public const informationLanguages = [
		1 => [
			"text" => "Türkçe",
		],
		2 => [
	...
	public const systemMenuShowType = [
		1 => [
			"form_text" => "Üst Menü",
			"view_text" => "Üst Menü",
		],
	...
	public const systemUserMailSend = [
		1 => [
			"form_text" => "Evet",
		],
		2 => [
	...
	public const systemYesAndNoVersion2 = [
		1 => "Evet",
		2 => "Hayır"
	];
	...
	public const extensionsControl = [
		"img_and_pdf" => [
			"png",
			"jpg",
			"pdf",
	...
	public const subscriptionStatus = [
		1 => [
			"label" => "Ödendi",
	...
	public const actionPermissionKey = "i";
	public const months = [
		"tr" => [
			"long" => [
				"01" => "Ocak",
